        ...
        .build(
            ...
            |configs| {
                configs
                    ...
                    .expect(
                        "No OpenGL configurations available",
                    )
            },
        )
        .expect(
            "Failed to create OpenGL display",
        );
                    ...
                    Event::AboutToWait => {
                        ...
                        let play_mode =
                            app.view
                                == engine::View::Editor
                                && app.editor.mode
                                    == engine::EditorMode::Play
                                && app.character_system.has_characters();

                        if play_mode
                            && !play_cursor_captured
                        {
                            match window
                                .set_cursor_grab(
                                ...
                                )
                            {
                                ...
                                Err(error) => {
                                    eprintln!(
                                        "Failed to capture Play mode cursor: {}",
                                        error
                                    );
                                }
                            }
                            ...
                            && play_cursor_captured
                        {
                                ...
                                )
                            {
                                ...
                                Err(error) => {
                                    eprintln!(
                                        "Failed to release Play mode cursor: {}",
                                        error
                                    );
                                }
                            }
